...
<body>
    <header>
        ...
        <nav class="title" id="title">
           <h3>All Canceled Passenger Ticket Booking Information</h3>
        </nav>
        ...
        <div class="scheuledetails">
            <div class="cardheader">
                <h2><?php
                    ...
                    if($con){
                        ...
                        $search="select * from cancleticket";       
                ...
                <span>&nbsp;2024</span></h2>
                <div class="search">
                    <form action="search_cancle.php" method="POST" encty>
            ...
            <?php
                ...
                if($con){
                    ...
                    mysqli_query($con,$db) or die(mysqli_error($con));
                    mysqli_select_db($con,"train_ticket_booking") or die(mysqli_error($con));
                    $check_table_query = "SHOW TABLES LIKE 'cancleticket'";
                    $result = mysqli_query($con, $check_table_query);
                    if(mysqli_num_rows($result) == 0) {
                        $tabel="CREATE TABLE IF NOT EXISTS cancleticket (
                    ...
                    if(mysqli_num_rows($result) == 0){
                        ...
                        echo "
                        <table>
                            <capLion><b>Canceled Passengers</b></capLion>
                            <tr>
                                <th>NO</th>
                                <th>First Name</th>
                                <th>Last Name</th>
