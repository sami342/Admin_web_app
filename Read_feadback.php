        ...
        <div class="scheuledetails">
            ...
            <?php
                ...
                if ($con) {
                    ...
                    $search_feedback = "select * from feedback where email LIKE '%$id%' or first_name LIKE '%$id%'";
                    $result_feedback = mysqli_query($con, $search_feedback) or die(mysqli_error($con));

                    // Check if there is data in any table
                    if (mysqli_num_rows($result_passenger) == 0 && mysqli_num_rows($result_cancleticket) == 0 && mysqli_num_rows($result_feedback) == 0) {
                        echo "
                        <script>
